...
class ProductCategoryCrudController extends CrudController
{
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('slug')->label('URL')->hint('Будет сгенерировано автоматически из названия если оставить пустым');
        ...
        CRUD::field('meta_text')->fake(true)->store_in('seo')->type('ckeditor')->label('Seo text');
