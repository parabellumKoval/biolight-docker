<template>
	<div class="social" :class="{active: active}" @click="toggle()" v-click-outside="close">
		<div class="social__icon icon-22">
...
<style lang='scss' src='@/assets/scss/components/the-social.scss' scoped></style>
